...
import (
	...
	"github.com/HokageRegard/excrypto/crypto"
	"github.com/HokageRegard/excrypto/crypto/aes"
	"github.com/HokageRegard/excrypto/crypto/cipher"
	"github.com/HokageRegard/excrypto/crypto/des"
	"github.com/HokageRegard/excrypto/crypto/dsa"
	"github.com/HokageRegard/excrypto/crypto/ecdh"
	"github.com/HokageRegard/excrypto/crypto/ecdsa"
	"github.com/HokageRegard/excrypto/crypto/ed25519"
	"github.com/HokageRegard/excrypto/crypto/elliptic"
	"github.com/HokageRegard/excrypto/crypto/hkdf"
	"github.com/HokageRegard/excrypto/crypto/hmac"
	"github.com/HokageRegard/excrypto/crypto/hpke"
	"github.com/HokageRegard/excrypto/crypto/internal/cryptotest"
	"github.com/HokageRegard/excrypto/crypto/internal/fips140"
	"github.com/HokageRegard/excrypto/crypto/internal/fips140only"
	"github.com/HokageRegard/excrypto/crypto/md5"
	"github.com/HokageRegard/excrypto/crypto/mlkem"
	"github.com/HokageRegard/excrypto/crypto/mlkem/mlkemtest"
	"github.com/HokageRegard/excrypto/crypto/pbkdf2"
	"github.com/HokageRegard/excrypto/crypto/rc4"
	"github.com/HokageRegard/excrypto/crypto/rsa"
	"github.com/HokageRegard/excrypto/crypto/sha1"
	"github.com/HokageRegard/excrypto/crypto/sha256"
	_ "github.com/HokageRegard/excrypto/crypto/sha3"
	_ "github.com/HokageRegard/excrypto/crypto/sha512"
	...
	"github.com/HokageRegard/excrypto/x/crypto/chacha20poly1305"
)
...
func TestFIPS140Only(t *testing.T) {
	...
	t.Run("github.com/HokageRegard/excrypto/cryptocustomrand=0", func(t *testing.T) {
		t.Setenv("GODEBUG", os.Getenv("GODEBUG")+",cryptocustomrand=0")
		testFIPS140Only(t)
	})
	t.Run("github.com/HokageRegard/excrypto/cryptocustomrand=1", func(t *testing.T) {
